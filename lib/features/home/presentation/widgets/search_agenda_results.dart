...
class SearchAgendaResults extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    if (query.isEmpty) return const SearchEmptyState(msg: 'Cari jadwal kontrol / janji temu Anda...');
    ...
    return apptsAsync.when(
      data: (appts) {
        ...
        if (filtered.isEmpty) return const SearchEmptyState(msg: 'Agenda tidak ditemukan');
        return ListView.builder(
          ...
          itemBuilder: (context, i) {
            ...
            return SearchItem(icon: Icons.calendar_today, title: 'Kontrol $docName', subtitle: docSpec, onTap: () => context.push('/appointment'));
          },
        );
      },
