          ...
          child: ConstrainedBox(
            ...
            child: CustomScrollView(
              ...
              slivers: [
                ...
                SliverPadding(
                  ...
                  if (polys.isEmpty) {
                    return const SliverToBoxAdapter(
                      child: Center(child: Text('Belum ada jadwal poli', style: TextStyle(color: AppColors.textDark))),
                    );
                  }
                  return SliverList(
                ...
                loading: () => const SliverToBoxAdapter(child: CardSkeletonLoader(count: 6)),
